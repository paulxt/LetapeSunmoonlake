                            ...
                            <Accordion.Item eventKey="3">
                                ...
                                <Accordion.Body>
                                    ...
                                    <ul>
                                        ...
                                        <li>{language === "Chinese" ? "收到郵寄物資代表已完成報到手續，請於當日逕自前往活動會場集合即可。" : ""}</li>
                                        <li>{language === "Chinese" ? "收到郵寄物資後，請妥善保管，遺失恕不再補發。" : ""} </li>
                                        <li>{language === "Chinese" ? "若有其他相關賽事問題須詢問，請來電或來信洽詢，將有專人為您服務。" : ""}</li>
                                        <li>{language === "Chinese" ? "客服電話 02-5591-5658分機25，服務時間：週一至週五工作日 09：00-18：00" : ""}</li>
                                        <li>{language === "Chinese" ? "客服信箱 katie@body-marketing.com ，回覆時間：週一至週五工作日 09：00-18：00" : ""}</li>
                                        <li>{language === "Chinese" ? "FB客服 「2024環法挑戰賽-日月潭站」，服務時間：週一至週五工作日 09：00-18：00" : ""}</li>
                                    </ul>
                                </Accordion.Body>
                            </Accordion.Item>
                        </Accordion>
