                ...
                <Row className='align-items-center'>
                    <Col className='event-info-col mt-5'>
                        ...
                        <ul className='ul-decimal'>
                            <li>本活動一律採<a href="https://bao-ming.com/eb/content/6179#29049" target='_blank' rel='noreferrer' >伊貝特線上報名</a></li>
                            <li>請審慎填寫報名資料，凡完成報名手續不得要求更改比賽組別、紀念車衣尺寸。</li>
                            <li>本活動採取以下三種退費方案，欲申請退費者請填寫表單：<br/><span>（<a href="https://forms.gle/bQsa2nvfSr79cBXL8" target='_blank' rel='noreferrer'>https://forms.gle/bQsa2nvfSr79cBXL8</a> ）</span></li>
                        </ul>
                        <ul>
