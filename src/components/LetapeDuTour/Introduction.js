        ...
        <section className="letape-du-tour-introduction">
            <Container>
                <Row className='aling-items-center mt-5'>
                    <Col>
                        <h3 className='text-center'>你是頂尖的自行車選手嗎？</h3>
                ...
                <Row className='aling-items-center mt-5'>
                    <Col md={6}>
                        ...
                        <p className='px-5 mt-5'>參加世界各地的任一L'Etape by Tour de France賽事，您將獲得L'Etape du Tour法國站的獨家優先報名權</p>
                    </Col>
                    <Col md={6} className='bg-white text-black'>
                        <h3 className='text-stroke-reverse text-center'>L’Étape Championship</h3>
                        <p className='px-5 mt-5'>在全球L’ÉTape 各站長距離組中總體（男子/女子）排名前三名，將獲得資格參加法國的L'Etape du Tour 錦標賽</p>
                    </Col>
                </Row>
            </Container>
        </section>
