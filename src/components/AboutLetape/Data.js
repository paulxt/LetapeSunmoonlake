                ...
                <Row className="align-items-center px-3 py-3" >
                    <Col md={6} className="px-3 py-5" >
                        <div className="data-bx">
                            <h3>21</h3>
                            <p className='text-center'>環法自行車賽L’Étape系列賽的落地站</p>
                        </div>
                    </Col>
                    <Col md={6} className="px-3 py-5" >
                        <div className="data-bx">
                            <h3>50,000</h3>
                            <p className='text-center'>預計參加 2024 L’ÉTape 自行車賽的車手人數</p>
                        </div>
                    </Col>
                    <Col md={6} className="px-3 py-5" >
                        <div className="data-bx">
                            <h3>32</h3>
                            <p className='text-center'>全球32場環法自行車賽L’Étape系列賽事</p>
                        </div>
                    </Col>
                    <Col md={6} className="px-3 py-5" >
                        <div className="data-bx">
                            <h3>3,500</h3>
                            <p className='text-center'>共騎乘全球超過3,500公里自行車路線</p>
                        </div>
                    </Col>
                </Row>
            </Container>
